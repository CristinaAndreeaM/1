...
public class Biblioteca {
    ...
    static String[] _cat = {"Romantic", "Sf", "Actiune", "Aventura"};
    ...
    public static void main(String[] args) {
        ...
        if (optiune == 1)
        {
            ...
            if (optiuneAutor == 1)
            {
                ...
                if (ok == false)
                    System.out.println("Nu exista carte de aceasta categorie scrisa de  acest autor");
            }
        ...
        } else if (optiune == 2)
        {
            ...
            if (optiuneAutor == 1) {
                boolean ok = false;
                for (int i = 0; i <= 7; i++) {
                    if (carti[i]._categorie.equals("Actiune") && carti[i]._autori._nume.equals("John Daselv")) {
                        ok = true;
                        System.out.println(carti[i].toString());
                    }
                    if (ok == false)
